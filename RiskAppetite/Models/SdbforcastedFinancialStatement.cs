...
public partial class SdbforcastedFinancialStatement
{
    public int Id { get; set; }

    public string? ForcastedYear { get; set; }

    public string? ForcastedQuarter { get; set; }
    ...
    public string? ForcasteNonCurrentAssetsHeldForSaleNet { get; set; }
    ...
    public string? ForcastedCustomersDeposits { get; set; }
    ...
    public string? ForcastedBorrowingOrNationalBankLiabilities { get; set; }
    ...
    public string? ForcastedProvisionalProfitOverLoss { get; set; }
    ...
    public string? ForcastedLoansAndAdvancePrincipal { get; set; }
